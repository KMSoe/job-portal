...
class JobApplicationReviewService
{
    public function findByParams($request)
    {
        ...
        $query = JobApplicationReviewer::with(['application.applicant', 'application.jobPosting'])
    ...
    public function findById($id)
    {
        ...
        return JobApplicationReviewer::with(['application.applicant', 'application.jobPosting'])
            ->where('reviewer_id', $user->id)
            ->findOrFail($id);
    }
}
