...
class ApplicantJobPostingResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            // Compensation
            'salary_type'                            => $applicant ? $this->salary_type : '***',
            'salary_currency_id'                     => $applicant ? $this->salary_currency_id : '***',
            'salary_amount'                          => $applicant ? $this->salary_amount : '***',
            'min_salary'                             => $applicant ? $this->min_salary : '***',
            'max_salary'                             => $applicant ? $this->max_salary : '***',
            'salary_notes'                           => $applicant ? $this->salary_notes : '***',
